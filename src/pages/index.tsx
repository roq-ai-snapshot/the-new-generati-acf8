...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`The New Generation of Im`}</title>

        <meta
          name="description"
          content="Experience The New Generation of Im - Your Ultimate Platform for Course Management, User Access, and Blogging. Register, Update, Delete, and Sell Courses with Ease."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjkxNDc0MzA5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`The New Generation of Im`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience The New Generation of Im - Your Ultimate Platform for Course Management, User Access, and Blogging. Register, Update, Delete, and Sell Courses with Ease.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                ...
                <Card userTypeName="Registered User" type="registered-user" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
