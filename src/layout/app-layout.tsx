...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'course-creator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Blogs', path: '/blogs', entity: 'blog', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Courses', path: '/courses', entity: 'course', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
